...
const UpdateHomeapp = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!id) validationErrors.id = 'Ipads ID is required';
        ...
        try {
            const response = await axios.put('http://localhost:9090/admin/update/homeapp', formData, {
                headers: {
            ...
            alert('homeapp updated successfully!');
        } catch (error) {
            console.error(error);
            alert('Error updating homeapp.');
        }
    };
