...
const InsertWatches = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:9090/admin/upload/watches', formData, {
                headers: {
            ...
            alert('watches uploaded successfully!');
        } catch (error) {
            console.error(error);
            alert('Error uploading watches.');
        }
    };
