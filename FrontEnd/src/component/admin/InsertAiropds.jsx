...
const InsertAirpods = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:9090/admin/upload/airpods', formData, {
                headers: {
            ...
            alert('airpods uploaded successfully!');
        } catch (error) {
            console.error(error);
            alert('Error uploading airpods.');
        }
    };
