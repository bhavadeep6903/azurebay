...
const InsertIpads = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:9090/admin/upload/ipads', formData, {
                headers: {
            ...
            alert('ipads uploaded successfully!');
        } catch (error) {
            console.error(error);
            alert('Error uploading ipads.');
        }
    };
