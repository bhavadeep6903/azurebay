...
const UpdateIpads = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put('http://localhost:9090/admin/update/ipads', formData, {
                headers: {
            ...
            alert('ipads updated successfully!');
        } catch (error) {
            console.error(error);
            alert('Error updating ipads.');
        }
    };
