...
const InsertHomeapp = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:9090/admin/upload/homeapp', formData, {
                headers: {
            ...
            alert('homeapp uploaded successfully!');
        } catch (error) {
            console.error(error);
            alert('Error uploading homeapp.');
        }
    };
